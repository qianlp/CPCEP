...
<div class='mini-fit' style='width:100%;height:100%;'>
    <div id='miniDataGrid' class='mini-datagrid'
        ...
        <div property="columns">
            ...
            <div field="isKeyword" type="checkboxcolumn"  trueValue="1" falseValue="0" width="100" headerAlign="center">是否关键参数</div>
...
<script type='text/javascript'>
    ...
    //这里可以重新指定自定义的数据装载路径
    grid.setUrl("${pageContext.request.contextPath}/business/bid/loadSupplierMaterialParam.action");
    grid.load({purchaseMaterialId:purchaseMaterialId,supplierBidUuid:supplierBidUuid});
