...
<head>
    <title>招标</title>
    <meta name="description" content="招标">
    ...
    <div region="center"
       ...
       <%-- <div class="search_body" id="search_body">
        ...
        <div class='mini-fit' style='width:100%;height:100%;'>
            <div id='miniDataGrid' class='mini-datagrid' style='width:100%;height:100%;'  url="${pageContext.request.contextPath}/business/bulletin/queryBulletinData.action"
                 idField='unid' sizeList='[5,10,15,30]' pageSize='15' fitColumns='true'>
                <div property='columns'>
                    <div type="checkcolumn"></div>
                    <div type="indexcolumn">序号</div>
                    <div field="name" width="120" allowSort="true" align='center'>招标编号</div>
                    <div field="code" width="120" allowSort="true" align='center'>招标名称</div>
