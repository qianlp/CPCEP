...
<div class="col-md-7" name="FormMode" id="FormMode"
    ...
    <div class="widget-container fluid-height col-md-7-k" style="height:auto;border-radius:4px;padding-bottom: 10px">
        ...
        <fieldset style="margin: 10px;height: auto">
            <legend style="margin-left:10px;"><b>评标澄清</b></legend>
            <div class="mbox-body" style="height:auto;padding:10px;">
                ...
                <table style="width:95%;margin:5px;" id="tab">
                    <tr>
                        ...
                        <td class="td_right">
                            <input name="bidCode" class="mini-textbox" style="width:99%;" readonly="readonly" value="${code}"
                                   required="true">
                        </td>
                        <td class="td_left">招标名称：</td>
                        <td class="td_right">
                            <input name="bidName" class="mini-textbox" style="width:99%;" readonly="readonly" value="${name}"
                                   required="true">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="td_right">
                            <input name="issueType" class="mini-combobox"  value="${issueType}"
                    ...
                    <tr>
                        ...
                        <td class="td_right" colspan="6" style="padding:3px;">
                            <input name="remark" class="mini-textarea" style="width:99.6%" value="${remark}" required="true"
                                   title="备注">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="td_right">
                            <div id="upload">
                                <a id="file_1"></a>
                                <input type='hidden' name='clarifyFileUUID' value=''/>
        ...
        <div class="host-footer" align="right">
            ...
            <div class="footer-area" style="float: right">
                <div class="pull-left" id="btnContL" style="float: right">
                    <button class='btn btn-md btn-primary' type='button' style='margin:0px 7px 15px 7px' onclick="savePage();">
                        保&nbsp;&nbsp;存
                    </button>
...
<script>
        ...
        layui.use('upload', function () {
            ...
            var uploadInst = upload.render({
                ...
                , done: function (res) {
                    ...
                    $("input[name=clarifyFileUUID]").val(result.data.uuid);
    ...
    function savePage() {
        ...
        var clarifyFileUUID = $("input[name=clarifyFileUUID]").val();
        data.clarifyFileUUID = clarifyFileUUID;
