...
<head>
    <title>采购申请选择</title>
    <meta name="description" content="采购申请选择">
    ...
    <div region="center"
        ...
        <div class="search_body" id="search_body">
            <div class="search_content">
                <div class="search_title">采购申请编号：</div>
                <div class="search_field" Operator="@" DataType="text" Item="">
                    <input name="purchaseCode" id="purchaseCode" class="mini-textbox">
                </div>
            </div>
            <div class="search_content">
                <div class="search_title">采购申请名称：</div>
                <div class="search_field" Operator="@" DataType="text" Item="">
                    <input name="purchaseName" id="purchaseName" class="mini-textbox">
                </div>
            </div>
        ...
        <div class='mini-fit' style='width:100%;height:100%;'>
            <div id='miniDataGrid' class='mini-datagrid' style='width:100%;height:100%;'  url="${pageContext.request.contextPath}/business/procurement/queryPurchaseApplyData.action"
                 idField='unid'  fitColumns='true' showPager="false">
                <div property='columns'>
                    <div type="checkcolumn"></div>
                    <div type="indexcolumn">序号</div>
                    <div field="purchaseCode" width="120" allowSort="true" align='center'>采购申请编号</div>
                    <div field="purchaseName" width="120" allowSort="true" align='center'>采购申请名称</div>
                    ...
                    <div field="remark" width="120" allowSort="true" align='center'>采购描述</div>
