		...
		<div class="rmain">
			...
			<c:choose>
				<c:when test="${status == 9}">
					<div style="text-align: center;"><b style="color: blue;">账号审核中</b></div>
				</c:when>
				<c:when test="${status == 8}">
					<div style="text-align: center;"><b style="color: red;">账号没有通过审核</b></div>
					<br>
					<div style="text-align: center;"><b style="color: red;">审核失败信息:${content}</b></div>
				</c:when>
			</c:choose>
			<div class="rm_con">
				...
				<form name="UserForm" method="post" action="" id="register">
					<table class="m-table" style="width:1000px;" id="orderitems">
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" name="name" value="${ext.name}" style="width:300px" onvalidation="onValidation"  required="true" maxlength="200" class="required seblanks u-ipt mini-textbox" required="true">
								</div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.registerAddress}" name="registerAddress" onvalidation="onValidation"  style="width:300px" maxlength="60" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.taxpayerNo}" name="taxpayerNo" maxlength="25" onvalidation="onValidation"  style="width:300px" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.corporations}" name="corporations"  onvalidation="onValidation"  style="width:300px"  maxlength="25" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input name="nature" type="text"   value="${ext.nature}"  onvalidation="onValidation"  style="width:300px" 
                                   ...
                                   allowInput="true" required="true"  title="企业性质"
                                  >
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.registerCapital}"  onvalidation="onValidation"  style="width:300px"  name="registerCapital" maxlength="25" class="required u-ipt mini-textbox" required="true" vtype="int"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.registerTime}"  onvalidation="onValidation"  style="width:300px"  name="registerTime" maxlength="25" class="required u-ipt mini-datepicker" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.contacts}"  onvalidation="onValidation"  style="width:300px"  name="contacts" maxlength="25" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.contactAddress}"  onvalidation="onValidation"  style="width:300px"  name="contactAddress" maxlength="60" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.phon}" name="phon"  onvalidation="onValidation"  style="width:300px"  maxlength="25" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.mobile}" name="mobile"  onvalidation="onValidation"  style="width:300px"  maxlength="25" class="required u-ipt mini-textbox" required="true">
								</div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.fax}" name="fax"  onvalidation="onValidation"  style="width:300px"  maxlength="25" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.email}" name="email"  onvalidation="onValidation"  style="width:300px"  maxlength="25" class="required u-ipt mini-textbox" required="true" vtype="email"></div>
						...
						<tr>
							...
							<td >
									<textarea class="mini-textarea" name="materialName" id="materialName"   style="width:500px"  value="${ext.materialName}"  readonly="readonly"  required="true"></textarea>
									<textarea class="mini-textarea" name="materialId" id="materialId"  value="${ext.materialId}" style="display: none" readonly></textarea>
...
<!-- 原【营业执照】、【税务登记证】、【织机构代码证】去掉换成【社会统一信用代码】 -->
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${ext.license}" name="license" onvalidation="onValidation"  style="width:300px" maxlength="25" class="required u-ipt mini-textbox" required="true">
								</div>
								<button type="button" class="layui-btn layui-btn-sm" id="licenseFile">
									<i class="layui-icon">&#xe67c;</i>上传
								</button>
								<div class="adpSign">
									<span id="licenseFileSpan">
										<c:if test="${licenseFile != null}">
										<span style="margin-right: 10px;">
											<a href="">${licenseFile.fileName}</a>
											<input type="hidden" name="licenseFile" value="${licenseFile.uuid}"/> 
											<a style="color:red;" href="javascript:void(0);" onclick="removeFile(this);">×</a>
										</span>
										</c:if>
									</span>
								</div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${billing.billingName}" name="billingName" onvalidation="onValidation"  style="width:300px" maxlength="25" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${billing.bankAccount}" name="billingBankAccount" maxlength="25" onvalidation="onValidation"  style="width:300px" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${billing.bankName}" onvalidation="onValidation"  style="width:300px" name="billingBankName" maxlength="25" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${billing.taxpayerId}" onvalidation="onValidation"  style="width:300px" name="billingTaxpayerId" maxlength="25" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${billing.address}" onvalidation="onValidation"  style="width:300px" name="billingAddress" maxlength="60" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								<div class="adpForm">
									<input type="text" value="${billing.phone}" onvalidation="onValidation"  style="width:300px" name="billingPhone" maxlength="25" class="required u-ipt mini-textbox" required="true"></div>
						...
						<tr>
							...
							<td>
								...
								<span id="performanceFile">
									<c:forEach items="${performanceFiles}" var="attachement">
									<span style="margin-right: 10px;">
										<a href="">${attachement.fileName}</a>
										<input type="hidden" name="performance" value="${attachement.uuid}"/>
										<a style="color:red;" href="javascript:void(0);" onclick="removeFile(this);">×</a>
									</span>
									</c:forEach>
								</span>
						...
						<tr>
							...
							<td>
								...
								<span id="performance_proveFile">
									<c:forEach items="${performanceProveFiles}" var="attachement">
									<span style="margin-right: 10px;">
										<a href="">${attachement.fileName}</a>
										<input type="hidden" name="performanceProve" value="${attachement.uuid}"/>
										<a style="color:red;" href="javascript:void(0);" onclick="removeFile(this);">×</a>
									</span>
									</c:forEach>
								</span>
						...
						<tr>
							...
							<td>
<!-- 								<div class="adpForm"> -->
<!-- 									<input type="text" value="${ext.certificate}" name="certificate" onvalidation="onValidation"  style="width:300px" maxlength="25" class="required u-ipt mini-textbox" required="true"> -->
<!-- 								</div> -->
								<button type="button" class="layui-btn layui-btn-sm" id="certificateFile">
									<i class="layui-icon">&#xe67c;</i>上传
								</button>
								<div class="adpSign">
									<span id="certificateFileSpan">
										<c:if test="${certificateFile != null}">
										<span style="margin-right: 10px;">
											<a href="">${certificateFile.fileName}</a>
											<input type="hidden" name="certificateFile" value="${certificateFile.uuid}"/>
											<a style="color:red;" href="javascript:void(0);" onclick="removeFile(this);">×</a>
										</span>
										</c:if>
									</span>
						...
						<tr>
							...
							<td>
								...
								<span id="otherFile" >
									<c:forEach items="${otherFiles}" var="attachement">
									<span style="margin-right: 10px;">
										<a href="">${attachement.fileName}</a>
										<input type="hidden" name="otherAttachment" value="${attachement.uuid}"/>
										<a style="color:red;" href="javascript:void(0);" onclick="removeFile(this);">×</a>
									</span>
									</c:forEach>
								</span>
					...
					<input type="hidden" name="uuid" value="${ext.uuid}"/>
				</form>
			</div>
			<c:if test="${status != 9}">
...
<script>
	...
	function register() {
        ...
        //var taxCertificateFile = $("input[name=taxCertificateFile]");
        //var orgCodeFile = $("input[name=orgCodeFile]");
        var certificateFile = $("input[name=certificateFile]");
        if(performance.length == 0 || performanceProve.length == 0 || otherAttachment.length == 0 || licenseFile.length == 0
			|| certificateFile.length == 0) {
            layer.msg("相关附件必须上传!");
            return ;
		}
        layer.load(1);
		$.post("${pageContext.request.contextPath}/business/update.action", form.serialize(), function(result) {
		    layer.closeAll();
		    result = mini.decode(result);
			if(result.code != 200) {
	...
	$(function() {
        layui.use(['layer', 'upload'], function(){
            ...
            upload.render({
                elem: '#licenseFile',
                accept : "file",
                url: '${pageContext.request.contextPath}/business/upload.action?type=4',
                before : function() {
                  layer.load(1);
                },
                done: function(res){
            ...
            upload.render({
                ...
                multiple : true,
                    ...
                    var html = "<span style='margin-right: 10px;'><a href=''>" + file.fileName + "</a><input type='hidden' name='" + name + "' value='" + file.uuid + "'/> <a style='color:red;' href='javascript:void(0);' onclick='removeFile(this);'>×</a></span>";
                    $("#" + id + "File").append(html);
                    layer.msg(res.message);
                },
                error: function(){
