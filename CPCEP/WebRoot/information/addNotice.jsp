...
<script type="text/javascript">
			...
			gCkEditor = CKEDITOR.appendTo('editor', {
				...
				on : {
					instanceReady : function(ev) {
						gCkEditor.setData(gForm.noticeMessage.value);
					}
				}
			});
		}
	...
	function saveFun(){
		gForm.noticeMessage.value = gCkEditor.getData();
	}
...
<div style="display:none">
	...
	<input name="status" />
	<textarea  name="noticeMessage" id="noticeMessage" >${comObj.noticeMessage}</textarea>
...
<div class="col-md-7" name="FormMode" id="FormMode"
	...
	<div class="widget-container fluid-height col-md-7-k"
		...
		<div class="mbox-header">
			<span class="form-title"
				style="height:100%;line-height:45px;text-align:center;">公告发布
			</span>
		</div>
	...
	<div class="widget-container fluid-height col-md-7-k"
		...
		<div class="mbox-header">
			<span class="form-title"
				style="height:100%;line-height:45px;text-align:center;"> 公告内容</span>
		</div>
