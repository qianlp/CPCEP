						...
						<td width="940" height="60" valign="bottom"><table
								...
								<tr>
									...
									<td width="810" height="30" align="center"><span
										class="subject">${requestScope.news.name}</span></td>
									<td width="65" height="30">&nbsp;</td>
								</tr>
							</table></td>
					</tr>
							...
							<table width="960" height="30" border="0" cellpadding="0"
								...
								<tr>
									...
									<td width="900"
										...
										align="center">发布人：${requestScope.news.createBy}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发布时间：${requestScope.news.createDate}
									</td>
									<td width="30">&nbsp;</td>
								</tr>
							</table>
...
$.ajax({
	url : "${pageContext.request.contextPath}/profile/findAllAdenexaJson.action?area=att_att_news&parentDocId=${requestScope.news.curDocId}",
