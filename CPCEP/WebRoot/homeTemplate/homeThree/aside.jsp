			...
			<div class="nano-content">
				...
				<ul class="nav nav-tabs nav-justified">
					...
					<li><a href="#demo-asd-tab-2" data-toggle="tab"> <i
							class="demo-pli-information icon-fw"></i> Report
					</a></li>
					<li><a href="#demo-asd-tab-3" data-toggle="tab"> <i
							class="demo-pli-wrench icon-fw"></i> Settings
					</a></li>
				</ul>
				<div class="tab-content">
						...
						<div class="pad-hor">
							<p class="text-muted">
								Lorem ipsum dolor sit amet, consectetuer <a data-title="45%"
									class="add-tooltip text-semibold" href="#">adipiscing elit</a>,
								sed diam nonummy nibh. Lorem ipsum dolor sit amet.
							</p>
							<small class="text-muted"><em>Last Update : Des 12,
									2014</em></small>
						</div>
					...
					<div class="tab-pane fade" id="demo-asd-tab-2">
						...
						<div class="pad-all">
							...
							<p class="text-muted">
								Get <strong>$5.00</strong> off your next bill by making sure
								your full payment reaches us before August 5, 2016.
							</p>
						</div>
					...
					<div class="tab-pane fade" id="demo-asd-tab-3">
						<ul class="list-group bg-trans">
							...
							<li class="list-group-item">
								...
								<p class="mar-no">Invisible mode</p> <small class="text-muted">Cum
