...
<script language="JavaScript" type="text/javascript">
	...
	function ToSave(){
		...
		//获取可以选择的数据
	//	var data=TreeGrid.getSelecteds();
	...
	function ToDel(){
		...
		if(ids!="" || ids!="undefined"){
			var path="${pageContext.request.contextPath}/profile/fileDirectoryNewDelete.action";
			$.post(path,{
				"uuid":ids
			},function(data){
	...
	function ajaxSave(data){
		...
		var path="${pageContext.request.contextPath}/profile/fileNewDirectoryUpdate.action";
		$.post(path,{prjID:"${param.prjID}",
			data:data
		},function(data){
			mini.unmask(document.body);
			//保存完刷新
...
<div class='mini-toolbar' style='padding:0;border-bottom-width:0;'>
    ...
    <div class="mini-fit" id="CatalogFit" style="height:100%;">
		...
		idField="UID" parentField="parentTaskUID"  allowAlternating="true" expandOnLoad="0" resultAsTree="false">
            <div property="columns">
                <div type="checkcolumn" width="50" ></div>
                <div field="catalogNo" name="catalogNo" width="180" headerAlign="center" align="left">目录编号</div>
		  ...
		  <div field="remark" width="300"  headerAlign="center" align="left">备注
			<input property="editor" class="mini-textarea" style="width:100%;" />
			</div>
         </div>
        </div> 
