...
<script src="../js/file/swfupload/swfupload.package.js" type="text/javascript"></script>
<script src="../js/file/swfupload/handlers.js" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="../js/file/swfupload/css/swfupload.css">
<div class="col-md-7" name="FormMode" id="FileMode"
		style="width:100%;margin:20px auto;float:none;display:none;">
