...
mini.extend(ProjectMenu, mini.Menu, {
    _create: function () {
        ...
        var menuItems = [
            //{ type: "menuitem", iconCls: "icon-goto", text: "查看日志", name: "goto" },
            //'-',
    ...
    __OnRemove: function (e) {
        ...
        if (task) {
            ...
            mini.alert("请选择要删除的任务");
        }
    }

});

var ProjectReadMenu = function () {
    ProjectReadMenu.superclass.constructor.call(this);
}

mini.extend(ProjectReadMenu, mini.Menu, {
    _create: function () {
        ProjectReadMenu.superclass._create.call(this);
