					...
					<div class="mbox-body" style="height: 90%;">
						<div id="miniSenDataGrid" class="mini-datagrid" showPager="false" style="width:100%;height:100%;" idField="id" sizeList="[5,10,15,30]" pageSize="15" multiSelect="true" >
							<div property="columns">
								...
								<div field="registerStartTime" width="120" allowSort="true" headerAlign="center" align="center" format="yyyy-MM-dd H:mm:ss" timeFormat="H:mm:ss" showTime="true" showOkButton="true">报名开始时间</div>
								<div field="registerEndTime" width="120" allowSort="false" headerAlign="center" align="center" format="yyyy-MM-dd H:mm:ss" timeFormat="H:mm:ss" showTime="true" showOkButton="true">报名结束时间</div>
								<div field="bidStartTime" width="120" allowSort="true" headerAlign="center" align="center" format="yyyy-MM-dd H:mm:ss" timeFormat="H:mm:ss" showTime="true" showOkButton="true">投标开始时间</div>
								<div field="bidEndTime" width="120" allowSort="false" headerAlign="center" align="center" format="yyyy-MM-dd H:mm:ss" timeFormat="H:mm:ss" showTime="true" showOkButton="true">投标结束时间</div>
								<div field="bidOpenTime" width="120" allowSort="false" headerAlign="center" align="center" format="yyyy-MM-dd H:mm:ss" timeFormat="H:mm:ss" showTime="true" showOkButton="true" >预计投标时间</div>
						...
						<table class="table table-underline" id="NoticeDiv">
							...
							<div id="invitation" class="mini-datagrid" style="width:100%;height:100%;" idField="id" sizeList="[5,10,15,30]" showPager="false" pageSize="20" pager="#pager1" multiSelect="true" >
								<div property="columns">
									...
									<div field="endDate"width="100" allowSort="false" headerAlign="center" align="center" format="yyyy-MM-dd H:mm:ss" timeFormat="H:mm:ss" showTime="true" showOkButton="true">截至时间</div>
