...
<script language="JavaScript" type="text/javascript">
	...
	function goSubmit(){
		//校验导入模块类型选择值
		var imptype = mini.getbyName("imptype").getValue();
...
<form method="post" action="${pageContext.request.contextPath}/admin/saveImportExcel.action" enctype="multipart/form-data" name="_fmImportFile" id="fmImportFile">
	...
	<table border="0" cellpadding="1" cellspacing="2" style="width:98%;margin:0 auto;top:30px">
		...
		<tr>
			<td align="center">导入模块:
				<input id="combo1" class="mini-combobox" style="width:70%;" textField="text" valueField="id" emptyText="请选择..."
   					 url="./importExcelType.json" name="imptype" required="true" allowInput="true"/></td>
		</tr>
		<tr>
			<td align="center">
